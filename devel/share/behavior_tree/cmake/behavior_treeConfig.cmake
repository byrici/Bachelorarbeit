...
if("TRUE" STREQUAL "TRUE")
  set(behavior_tree_SOURCE_PREFIX /my_project/src/behavior_tree)
  set(behavior_tree_DEVEL_PREFIX /my_project/devel)
  ...
  set(behavior_tree_INSTALL_PREFIX /my_project/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'behavior_tree' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/my_project/src/behavior_tree/${idir}'.  ${_report}")
    endif()
